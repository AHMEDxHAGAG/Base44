...
export function BuildSection() {
  return (
    ...
    >
      <div className="px-5 pt-[50px] md:px-[5.21vw] md:pt-[10.42vw] min-[1100px]:px-[min(5.21vw,90px)] min-[1100px]:pt-[min(10.42vw,120px)]">
        <h2
        ...
        <p className="mt-[16px] text-[clamp(16px,1.25vw,24px)] leading-[1.25] md:mt-[12px] md:max-w-[min(45.9vw,882px)]">
          Whatever you&apos;re imagining, you can
          <br className="md:hidden" /> use vibe coding to build it on Base44.
        </p>
      </div>

      <div className="mt-[50px] grid grid-cols-1 gap-y-[25px] pb-[50px] md:gap-y-[3.12vw] min-[1100px]:mt-[min(4.4271vw,85px)] min-[1100px]:grid-cols-3 min-[1100px]:gap-x-[21px] min-[1100px]:gap-y-0 min-[1100px]:pb-[min(6.0417vw,116px)]">
        {buildCards.map((card) => (
          <article
            key={card.title}
            className="group flex min-h-[clamp(330px,91.67vw,436px)] flex-col border-0 border-b-[10px] border-solid border-b-[#ff6a00] bg-[#f9f7f4] px-[30px] pt-[33px] pb-[38px] min-[1100px]:min-h-[clamp(360px,27.6vw,530px)] min-[1100px]:px-[clamp(20px,1.5625vw,30px)] min-[1100px]:pt-[clamp(20px,1.5625vw,30px)] min-[1100px]:pb-[clamp(20px,1.5625vw,30px)] min-[1100px]:transition-colors min-[1100px]:duration-200 min-[1100px]:hover:bg-[#ff6a00]"
          >
            <h3 className="base44-display text-[clamp(28px,2.5vw,48px)] leading-[1.08]">
              {card.title}
            </h3>
            <div className="mt-auto">
              <p className="text-[clamp(16px,1.25vw,24px)] leading-[1.25]">
                {card.description}
              </p>
              {card.external ? (
